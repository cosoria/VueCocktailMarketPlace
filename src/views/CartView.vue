      ...
      <div class="col-md-5 col-lg-4 order-md-last">
        ...
        <ul class="list-group mb-3">
          ...
          >
            ...
            <span class="text-body-secondary">${{ item.subTotal.toFixed(2) }}</span>
          </li>
          <!-- 
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="address2" class="form-label"
                >Address 2 <span class="text-body-secondary">(Optional)</span></label
              >
              <input
                type="text"
                class="form-control"
...
export default {
  ...
  //             {
  //                 name: "Product 1",
  //                 id: "id-from-product-1",
  //                 subTotal: 30,
  //             },
  //             {
  //                 name: "Product 2",
  //                 id: "id-from-product-2",
  //                 subTotal: 40.3,
  //             },
  //             {
  //                 name: "Product 3",
  //                 id: "id-from-product-3",
  //                 subTotal: 50,
  //             },
  //             {
  //                 name: "Product 4",
  //                 id: "id-from-product-4",
  //                 subTotal: 60.5,
  //             },
  //         ]
  //     };
